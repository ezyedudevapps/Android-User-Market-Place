...
import com.ezyedu.student.adapter.ProcessingOrderAdapter;
import com.ezyedu.student.model.Globals;
import com.ezyedu.student.model.ImageGlobals;
import com.ezyedu.student.model.ProcessingOrders;
...
public class Processing_Orders_Fragment extends Fragment {

    RecyclerView recyclerView;
    RequestQueue requestQueue;
    ProcessingOrderAdapter processingOrderAdapter;
    private List<ProcessingOrders> processingOrdersList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_processing__orders_, container, false);
        requestQueue= Volley.newRequestQueue(getContext());
        recyclerView = view.findViewById(R.id.processing_recyc);
            ...
            public void onResponse(JSONObject response)
            {
                ...
                try {
                    ...
                    for (int i = 0; i<jsonArray.length();i++)
                    {
                        ...
                        {
                            ProcessingOrders post = new ProcessingOrders(order_id,order_ref_id,vendor_name,ven_images,final_amount,status,date);
                            processingOrdersList.add(post);
                            Log.i("ArraySizeGetOrders", String.valueOf(processingOrdersList.size()));
