...
public class Search_Course_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search__course_);

        requestQueue= Volley.newRequestQueue(this);

        linearLayout = findViewById(R.id.ln_crse);
        ...
        recyclerView = findViewById(R.id.search_course_recycler);
        searchCoursesAdapter = new SearchCoursesAdapter(Search_Course_Activity.this,searchCourseList);
        manager = new GridLayoutManager(Search_Course_Activity.this, 2);
    ...
    private void fetchCourses()
    {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error)
            {
                linearLayout.setVisibility(View.VISIBLE);
                progressDialog.dismiss();
           //     Toast.makeText(Search_Course_Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
