...
import com.ezyedu.student.adapter.SeperateFeedsAdapter;
...
public class Seperate_Feeds_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seperate__feeds_);
        ...
        seperateFeedsAdapter = new SeperateFeedsAdapter(Seperate_Feeds_Activity.this,seperateFeeds);
        recyclerView.setAdapter(seperateFeedsAdapter);
        fetchData();
        progressDialog = new ProgressDialog(Seperate_Feeds_Activity.this);
        progressDialog.show();
