...
public class ProcessingOrderAdapter extends RecyclerView.Adapter<ProcessingOrderAdapter.ProcessingHolder> {
    ...
    public ProcessingOrderAdapter(Context context, List<ProcessingOrders> processingOrdersList) {
    ...
    {
        ProcessingOrders pendingOrders = processingOrdersList.get(position);
